using PatientManagementServices.Domain.Enums;
...
namespace PatientManagementServices.Domain.Contracts
{
    public abstract class AuditableEntityExtendedAttribute<TId, TEntityId, TEntity>
         : BaseAuditableEntity<TId>, IEntityAuditableExtendedAttribute<TId, TEntityId, TEntity>
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <inheritdoc/>
       // public Enums.Enums Type { get; set; }
