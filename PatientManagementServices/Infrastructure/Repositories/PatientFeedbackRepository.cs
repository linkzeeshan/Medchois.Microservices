...
{
    public class PatientFeedbackRepository : GenericRepository<Feedback, long>, IPatientFeedbackRepository
    {
        public PatientFeedbackRepository(ApplicationDbContext context) : base(context)
        {
        }
